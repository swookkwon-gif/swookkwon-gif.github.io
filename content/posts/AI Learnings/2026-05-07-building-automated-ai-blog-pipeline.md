...
2. **환각(Hallucination)과 맥락 상실**: 여러 기사를 구글 검색으로 한꺼번에 긁어와 Gemini에게 "이거 전부 읽고 요약해 줘"라고 던져주다 보니, 한 번에 처리해야 할 정보량이 너무 많아 모델이 엉뚱한 결론을 내리거나 중요한 뉴스를 누락해 버리는 부작용이 심각했습니다.
