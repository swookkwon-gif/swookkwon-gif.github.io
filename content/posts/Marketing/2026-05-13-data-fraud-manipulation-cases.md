...
이 글에서는 이전 편([데이터가 거짓말을 하는 순간: 심화편](/posts/2026-05-13-data-misinterpretation-famous-cases))에서 다루지 않은, **의도적 조작·시스템적 오류·구조적 편향**이 초래한 역사상 가장 충격적인 데이터 사기와 착시 사례 10가지를 심층 분석합니다.
