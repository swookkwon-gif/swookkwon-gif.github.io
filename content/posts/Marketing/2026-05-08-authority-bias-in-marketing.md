...
### 테네리페 공항 참사 (1977년)
스페인령 카나리아 제도의 작은 공항(현 테네리페 노르테 공항)에서 발생한, 항공 역사상 최악의 인명 피해(583명 사망)를 낸 참사입니다. 
...
하지만 **PMax나 자동 적용 추천이 항상 마케터의 성과를 개선해 주지 않는다는 점은 이미 다수의 업계 전문 자료를 통해 검증된 사실입니다.** Search Engine Land 등 검색 마케팅 전문 매체들의 분석과 실증 사례들에 따르면, PMax는 이른바 '블랙박스'로 작동하여 광고주가 통제할 수 없는 저품질 지면(스팸성 웹사이트나 무관한 유튜브 채널)에 예산을 낭비하게 만들 위험이 높습니다. 또한, 구글의 자동 적용 추천 기능은 마케터의 궁극적인 비즈니스 목표(수익성 향상)보다는 플랫폼의 클릭 볼륨과 광고 소진액을 늘리는 방향(광범위 키워드 무분별 추가 등)으로 작동하는 경우가 많아, 오히려 전체 캠페인의 ROAS(광고비 대비 수익률)를 훼손한다는 비판을 꾸준히 받고 있습니다.
