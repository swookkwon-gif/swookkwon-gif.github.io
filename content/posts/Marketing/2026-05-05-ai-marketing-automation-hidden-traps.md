...
date: "2026-05-05"
excerpt: "구글 Performance Max와 AI Max는 마케팅 자동화의 미래로 불립니다. 그러나 저명 논문들과 실무 사례들은 이 AI가 충성 고객에게 과도하게 예산을 집행하고, 브랜드 키워드를 잠식하며, 부풀려진 ROAS로 성과를 정당화하고 있음을 경고합니다. 2억 달러를 삭감해도 매출이 줄지 않았던 P&G 사례부터, eBay의 기념비적 논문까지 — AI 마케팅 자동화의 구조적 문제를 파헤칩니다."
category: Marketing
tags:
  - PerformanceMax
  - AI마케팅
...
## 1. 기념비적 논문: eBay의 브랜드 키워드 실험 (2015)

이 주제를 이야기할 때 빠질 수 없는 논문이 있습니다.

**논문 정보:**
- **제목:** Consumer Heterogeneity and Paid Search Effectiveness: A Large-Scale Field Experiment
- **저자:** Thomas Blake, Chris Nosko, Steven Tadelis
- **저널:** *Econometrica* (경제학 분야 최고 저널), 2015
- **DOI:** [10.3982/ECTA12423](https://doi.org/10.3982/ECTA12423)

### 실험 내용

eBay는 자사의 브랜드 키워드 광고("eBay" 검색 시 나오는 유료 검색 광고)를 미국 내 특정 지역에서 **완전히 중단**하는 대규모 현장 실험(Field Experiment)을 수행했습니다. 이것은 관찰 연구가 아닌 **무작위 대조군 실험(RCT)**이었기에, 인과관계를 증명할 수 있었습니다.

### 충격적인 결과

> **브랜드 키워드 광고를 중단해도, 유입 트래픽의 99.5%는 자연 검색(Organic)으로 그대로 들어왔다.**

| 측정 항목 | 광고 ON | 광고 OFF | 차이 |
|----------|--------|---------|-----|
| 브랜드 검색을 통한 전체 유입 | 100% | 99.5% (자연검색으로 대체) | 0.5%p |
| 매출 변화 | 기준 | 유의미한 차이 없음 | ❌ |
| 구매 전환율 | 기준 | 유의미한 차이 없음 | ❌ |

즉, eBay가 브랜드 키워드에 쏟아붓던 수천만 달러는 **어차피 올 고객에게 광고비를 지불하고 있었던 것**입니다.

### 핵심 발견: 소비자 이질성(Consumer Heterogeneity)

이 논문의 진정한 가치는 여기서 더 나아갑니다. 비브랜드(Non-brand) 키워드 광고에 대해서도 실험한 결과, 광고 효과가 **소비자 유형에 따라 극단적으로 달랐습니다.**

- **신규/비활성 고객:** 비브랜드 광고가 유의미한 전환 증가 효과를 보임
- **기존 충성 고객:** 광고가 있든 없든 구매 행동에 거의 변화 없음

이것이 의미하는 바는 명확합니다. **AI가 '쉬운 전환'을 최적화할수록, 이미 구매할 사람에게 광고비를 쓰게 됩니다.** 이 논문이 2015년에 증명한 것을, 2026년의 Performance Max가 대규모로 재현하고 있는 것입니다.

---

## 2. Performance Max의 구조적 문제: "블랙박스가 당신의 돈을 쓰는 법"
...
## 3. 실전 사례: P&G가 2억 달러를 삭감했을 때 벌어진 일

이론이 아닌 실전의 증거를 봅시다.

### 💰 P&G의 2억 달러 디지털 광고 삭감 (2017년)

2017년, 세계 최대 광고주인 **프록터 & 갬블(Procter & Gamble)**의 최고 브랜드 책임자 마크 프리차드(Marc Pritchard)는 디지털 광고 시장에 폭탄선언을 했습니다.

> *"디지털 미디어 공급망은 기껏해야 불투명하고(Murky), 최악의 경우 사기(Fraudulent)입니다."*

P&G는 디지털 광고 예산 **2억 달러(약 2,600억 원)**를 삭감했습니다.

**결과:** 매출 성장률에 유의미한 영향이 없었습니다.

P&G의 CFO 존 뫼러(Jon Moeller)는 공식석상에서 이렇게 말했습니다.

> *"삭감된 디지털 광고 지출이 대체로 효과가 없었다(Largely Ineffective)는 것을 확인했습니다."*

P&G는 이 절감된 예산을 TV, 오디오, 이커머스 등 더 효과적인 채널에 재배치했으며, 비효율적인 마케팅을 20% 줄이면서 동시에 전체 미디어 도달률(Media Reach)을 10% 증가시켰다고 보고했습니다.

**P&G 사례가 증명하는 것:** 디지털 광고비의 상당 부분은 이미 구매할 고객에게 불필요하게 지출되고 있으며, 이를 삭감해도 실제 비즈니스에는 영향이 없을 수 있다.

---

## 4. AI 자동화가 만드는 5가지 바이어스

위 사례들에서 반복적으로 등장하는 패턴을 정리하면, AI 마케팅 자동화가 만드는 **5가지 구조적 편향**이 있습니다.
...
## 5. 해결 방법: 증분성(Incrementality) 중심의 마케팅으로 전환
...
2. **지역 분할 테스트(Geo-Split Test):** eBay 논문에서 사용한 방법론입니다. 특정 지역에서만 광고를 끄고, 대조군 지역과 비교합니다.
...
eBay의 논문이 2015년에 증명한 것 — 브랜드 광고의 99.5%는 불필요하다 — 을 2026년의 Performance Max가 더 정교하게, 더 대규모로, 더 보기 좋은 대시보드로 포장하여 반복하고 있습니다.

P&G가 2억 달러를 삭감해도 매출이 줄지 않았다는 사실은, 디지털 광고비의 상당 부분이 **'있으면 좋고 없어도 되는' 지출**이었음을 의미합니다.
...
- Blake, T., Nosko, C., & Tadelis, S. (2015). Consumer Heterogeneity and Paid Search Effectiveness: A Large-Scale Field Experiment. *Econometrica*, 83(1), 155–174. ([논문 보기](https://doi.org/10.3982/ECTA12423))
- P&G 2017 Digital Ad Spend Reduction. *The Wall Street Journal*, *Marketing Interactive*. Marc Pritchard의 ANA 연설 (2017). ([기사 보기](https://www.wsj.com/articles/p-g-cut-more-than-100-million-in-digital-ad-spending-1501191104))
