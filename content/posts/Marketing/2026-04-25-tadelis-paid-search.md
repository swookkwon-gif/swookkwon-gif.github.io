...
| **간헐적 구매자 (1~2회)** | 미미한 증가 | 브랜드 상기(Reminder) 효과 일부 존재 |
...
> [!WARNING]
> **데이터의 배신 (Observational vs. Experimental ROI)**
> 마케터들이 대시보드에서 흔히 보는 관측 데이터 기반(OLS)으로 성과를 측정했을 때 eBay 광고의 ROI는 **+4,100%**라는 터무니없는 착시가 나타났습니다. 하지만 진짜 인과관계(실험)를 측정한 결과는 **-63%**였습니다. 이 거대한 갭(Gap)이 바로 **'내생성(Endogeneity)'**이 만드는 환상입니다.
...
- [📄 논문 원문 다운로드 (PDF)](/papers/Tadelis.pdf)
