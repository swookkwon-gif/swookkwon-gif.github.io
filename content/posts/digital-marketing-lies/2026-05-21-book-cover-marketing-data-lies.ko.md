...
우버의 퍼포먼스 마케팅 책임자였던 케빈 프리쉬(Kevin Frisch)는 자사 광고가 극우 사이트 Breitbart에 노출되는 것을 막기 위해 조사를 시작했다가, 마케팅 대행사들의 경고에도 불구하고 연간 1억 5,000만 달러의 광고비 중 무려 **3분의 2인 1억 달러(약 1,300억 원)를 점진적으로 정지**했습니다.
...
*   **법적 공방의 전말 (소송 및 합의):**
    *   **덴츠(Dentsu) 산하 Fetch Media와의 소송전:** 우버는 2017년 9월, 자사 모바일 광고 대행을 담당하던 덴츠 계열의 **Fetch Media**를 상대로 4,000만 달러 규모의 계약 위반 및 광고 사기 방지 의무 위반 소송을 제기했습니다(출처: [TechCrunch 보도](https://techcrunch.com/2017/09/20/uber-sues-mobile-agency-fetch-for-40m-alleging-ad-fraud/)). 이에 Fetch Media 측은 "미지급 광고 대금 1,970만 달러를 떼먹기 위한 핑계"라며 2018년 1월 우버를 상대로 맞소송을 제기하며 강력히 반발했고, 양사는 긴 법정 공방 끝에 비공개 합의로 종결했습니다.
    *   **Phunware와의 600만 달러 극적 합의:** Fetch Media의 하청 모바일 광고 네트워크였던 **Phunware**는 우버에 미지급 광고료 310만 달러를 청구했으나, 우버는 가짜 클릭을 유도하는 '클릭 플러딩'과 '자동 리다이렉트' 등 사기 청구 혐의로 맞소송을 걸었습니다. 이 소송은 2020년 10월 샌프란시스코 지방법원(사건 번호 CGC-17-561546) 재판 과정에서 Phunware 측이 불리한 핵심 증거(내부 고발자 파일 및 원천 로그 데이터)를 의도적으로 파기·훼손(Spoliation of evidence)한 정황이 드러나면서 급변했습니다. 법원이 소송 종결성 제재(Terminating Sanctions, 무조건적 패소 처분)를 내리려 하자, Phunware는 파산을 피하기 위해 우버에 **총 600만 달러(약 80억 원)**를 지급하기로 합의하고 소송을 마무리했습니다. (출처: [Phunware 미국 SEC Form 8-K 공시](https://www.sec.gov/edgar/browse/?CIK=1665300) 및 [Adweek 보도](https://www.adweek.com/performance-marketing/uber-settles-mobile-ad-fraud-lawsuit-with-phunware-for-6-million/))
...
### ③ 이베이 (eBay) — 브랜드 & 논브랜드 검색 광고의 완전한 대체 효과 (2012-2015)
Thomas Blake(eBay), Steven Tadelis(UC Berkeley) 등이 발표하여 디지털 마케팅의 역사를 바꾼 기념비적 현장 실험 연구입니다. 이베이는 광고 매체와 키워드 특성에 따라 다음의 대규모 통제 실험을 순차적으로 진행했습니다.

*   **브랜드 키워드(Brand Keyword) 검색 광고 실험:**
    *   **1차 실험 (MSN/Yahoo! 중단):** 2012년 3월, MSN과 Yahoo! 포털에서 자사 브랜드 키워드('eBay') 검색 광고를 전면 중단하고, 광고를 유지하던 구글(Google)을 대조군(Control)으로 삼았습니다. 광고 정지 즉시 유료 클릭은 0으로 떨어졌으나, **자연 검색(Organic Search) 유입이 유료 클릭의 99.5%를 즉시 흡수**하여 전체 유입과 매출 변화가 전혀 없었습니다.
    *   **2차 실험 (Google 내 직접 중단):** 1차 실험 결과를 검증하기 위해 2012년 7월 구글 플랫폼 내에서도 'eBay' 브랜드 광고를 끄고 켜는 후속 실험을 직접 수행했으며, 마찬가지로 트래픽의 97% 이상이 자연 검색으로 대체됨을 확인했습니다.
*   **논브랜드 키워드(Non-brand Keyword) 검색 광고 실험:**
    *   이베이가 입찰 중이던 1억 개 이상의 비브랜드 키워드(예: 'used guitar', 'memory' 등)를 대상으로 진행했습니다. 구글의 **지역별 입찰 기능(Geographic Bid Feature)**을 활용하여 미국 내 210개 지리적 마케팅 영역(DMA) 중 약 30%를 무작위 선정해 구글 검색 광고를 60일간 전면 중단했습니다.
    *   **실측 결과:** 광고 차단 지역의 매출 변동률은 단 0.66%에 그쳐 통계적 의미가 없었습니다. 특히 연간 3회 이상 구매 이력이 있는 기존 단골 고객에게 광고의 증분 매출 기여 효과는 사실상 **0%**였습니다.
*   **통계적 왜곡 (가짜 ROI vs 진짜 ROI의 계산 차이):**
    *   **가짜 ROI (+4,100% ~ +1,400%):** 단순 회귀분석(OLS)이나 광고 대시보드의 '기여도(Attribution)' 기준입니다. 광고를 누르고 들어온 사람의 매출을 전부 광고 공으로 계산한 수치입니다. 주말 효과나 고소득 지역 등 외부 요인을 통제해도 +1,400%라는 기염을 토하지만, 이는 광고가 없었어도 어차피 이베이에 들어와 물건을 샀을 단골들의 트래픽을 가로챈 **'선택 편향(Selection Bias)'**과 쇼핑 시즌에 맞춰 광고비가 늘어나는 **'내생성(Endogeneity)'** 오류가 반영된 결과입니다.
    *   **진짜 ROI (-63%):** 무작위 통제 실험(RCT)과 **도구변수(Instrumental Variable) 분석**을 결합한 결과입니다. 광고를 완전히 꺼버린 30% 지역(실험군)과 광고를 유지한 70% 지역(대조군)의 매출을 비교하여 '광고가 없었을 때 안 샀을 사람(순수 증분)'만을 발라내기 위해 2단계 최소제곱법(2SLS)을 적용했습니다. 그 결과 광고 집행 유무에 따른 매출 변화는 통계적으로 **0**에 수렴했고, 집행된 광고비 대비 추가 매출이 없었기에 진짜 ROI는 **-63%**로 곤두박질쳤습니다.
    *   **💡 직관적 비유:** 이미 가게 문 앞으로 걸어오고 있는 단골손님에게 굳이 문을 열어주며 팁(광고비)을 쥐여준 뒤, 대시보드에는 그 손님이 지불한 매출 전체가 자기 공이라고 기록한 광고 플랫폼의 눈속임을 이베이가 실증 실험으로 폭로한 셈입니다.
...
13. Skift (2021.02.25). [Airbnb Outlines 2021 Vision After Weathering $4.6 Billion Pandemic Year Loss](https://skift.com/2021/02/25/airbnb-outlines-2021-vision-after-weathering-4-6-billion-pandemic-year-loss/).
14. Marketing Week (2023.02.15). [Airbnb: Marketing efficiency drives record profits](https://www.marketingweek.com/airbnb-marketing-efficiency-record-profits/).
15. Marketing Week (2022.05.04). [Airbnb earnings surge as it maintains focus on effective marketing spend](https://www.marketingweek.com/airbnb-earnings-surge-effective-marketing-spend/).
16. Marketing Week (2021.02.26). [Airbnb: We don't view performance marketing as a way to buy customers](https://www.marketingweek.com/airbnb-performance-marketing/).
17. Airbnb, Inc. (2021.02.26). [Airbnb, Inc. Q4 2020 Shareholder Letter / 2020 Annual Report](https://investors.airbnb.com/financials/quarterly-results/default.aspx).
