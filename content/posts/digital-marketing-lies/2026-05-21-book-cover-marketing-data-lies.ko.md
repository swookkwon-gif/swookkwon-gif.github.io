...
2020년 코로나19 팬데믹으로 인해 여행 수요가 급감하자, 에어비앤비는 생존을 위해 검색 광고 및 리타겟팅 등 퍼포먼스 마케팅 예산의 **90% 이상(약 8억 달러, 한화 약 1조 원)을 전격 삭감**하고 퍼포먼스 광고 집행을 거의 제로로 만들었습니다. 대시보드 상으로는 트래픽이 동반 폭락해야 정상이었으나, 결과는 경악스러웠습니다.
*   **실측 결과:** 광고비를 완전히 껐음에도 불구하고 전체 웹 사이트 트래픽은 **기존의 95% 수준으로 완벽하게 유지**되었습니다. 
*   **원인:** 퍼포먼스 마케팅이 신규 가입자를 만든 것이 아니었습니다. 이미 브랜드를 신뢰하고 직영 자사몰로 직접 들어오려던 고객의 검색 길목을 유료 광고로 차단하고 서서, 자연 검색(Organic) 트래픽을 가로채고 있었던 것입니다.
*   **재무 성과:** 에어비앤비는 이 낭비를 차단하여 마케팅 믹스를 재정비했고, 2021년 전체 매출은 2019년(팬데믹 이전) 대비 **25% 성장(59억 달러)**했으며 2022년에는 창사 이래 최초로 **19억 달러의 연간 순이익 흑자 전환**에 성공했습니다.
