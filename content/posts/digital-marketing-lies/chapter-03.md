---
title: "3장. 내 광고비를 훔쳐가는 유령들"
date: 2026-05-21T04:00:00+09:00
draft: false
tags: ["광고사기", "우버", "AdFraud", "카니발라이제이션"]
...
### 법정으로 간 진실
우버는 2017년 9월, 자사 모바일 광고 대행을 전담하던 덴츠(Dentsu) 그룹 산하의 **Fetch Media**를 상대로 4,000만 달러 규모의 계약 위반 및 광고 사기 혐의 소송을 제기했습니다. 이에 Fetch는 미지급 인보이스 대금 1,970만 달러를 받아내기 위해 우버를 상대로 맞소송을 제기하며 강력히 대립했고, 오랜 싸움 끝에 비공개 합의로 사건이 마무리되었습니다.

동시에 우버는 Fetch의 하위 모바일 광고 네트워크 중 하나인 **Phunware**를 상대로 클릭 플러딩, 강제 리다이렉트 등 대규모 가짜 광고를 통한 사기 과금 혐의로 맞소송을 걸어 치열한 공방을 벌였습니다. 이 소송은 2020년 10월 재판(사건 번호 CGC-17-561546) 도중 Phunware 측이 불리한 핵심 증거(내부 고발자 파일 및 광고 원천 로그)를 고의로 파기·인멸(Spoliation of evidence)한 정황이 밝혀지면서 급전직하했습니다. 법원이 소송 종결성 제재(Terminating Sanctions) 처분을 내리려고 하자, Phunware는 파국을 피하기 위해 우버에 **총 600만 달러(약 80억 원)**를 지급하는 조건으로 극적 합의를 맺고 소송을 종결했습니다(출처: 미국 SEC Form 8-K 공시). 이 사건은 광고 사기의 구조적 실태를 적나라하게 폭로한 역사적인 도화선이 되었습니다.
...
2020년, 전 세계를 덮친 코로나19 팬데믹으로 여행 수요가 전멸에 가까운 타격을 입자 에어비앤비(Airbnb)는 부도 직전의 비상 체제에 돌입했습니다. 생존을 위한 자구책으로 에어비앤비는 2020년 전체 마케팅 예산을 전년 대비 **58% 삭감**했으며, 검색 광고 및 리타겟팅 등 퍼포먼스 마케팅 예산은 **90% 이상(약 8억 달러)** 삭감하여 사실상 중단했습니다(출처: [에어비앤비(Airbnb) 공식 IR 실적 아카이브](https://investors.airbnb.com/financials/quarterly-results/default.aspx)).
...
당시 **월스트리트 저널(WSJ)**과 **Skift**, **Marketing Week** 등 주요 글로벌 비즈니스 미디어는 에어비앤비의 이 같은 결단을 "대시보드의 단기 ROAS 숫자에 매몰된 현대 디지털 광고 시장에 경종을 울린 패러다임의 대전환"이라고 대대적으로 보도했습니다. 체스키는 에어비앤비가 이미 하나의 명사이자 동사가 되었다고 강조하며, 퍼포먼스 광고비 삭감이 일시적 방책이 아니라 영구적 피벗(Permanent Pivot)이자 실제로 성공적인 전략임을 입증했습니다.
...
에어비앤비는 이 뼈아픈 교훈을 바탕으로 마케팅 예산의 낭비를 제거했고, 2022년 창사 이래 최초로 GAAP 기준 **19억 달러의 거대한 연간 순이익 흑자 전환**에 성공하며 디지털 업계의 생존 공식을 전면 새로 썼습니다. (에어비앤비의 마케팅 믹스 개선에 따른 브랜드 전략과 장단기 광고 밸런스에 대해 심층적으로 다룬 내용은 [브랜드 마케팅과 퍼포먼스 마케팅의 60:40 법칙](/posts/2026-05-21-les-binet-peter-field-long-and-short) 포스트를 참고하세요.)
...
*   "Airbnb Outlines 2021 Vision After Weathering $4.6 Billion Pandemic Year Loss." *Skift* (2021.02.25). [Link](https://skift.com/2021/02/25/airbnb-outlines-2021-vision-after-weathering-4-6-billion-pandemic-year-loss/)
*   "Airbnb: Marketing efficiency drives record profits." *Marketing Week* (2023.02.15). [Link](https://www.marketingweek.com/airbnb-marketing-efficiency-record-profits/)
*   "Airbnb earnings surge as it maintains focus on effective marketing spend." *Marketing Week* (2022.05.04). [Link](https://www.marketingweek.com/airbnb-earnings-surge-effective-marketing-spend/)
*   "Airbnb: We don't view performance marketing as a way to buy customers." *Marketing Week* (2021.02.26). [Link](https://www.marketingweek.com/airbnb-performance-marketing/)
