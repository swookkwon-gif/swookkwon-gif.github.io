...
5. **기타 뉴스**: Top 10 이외 기사는 `## 📌 기타 뉴스 모아보기` 섹션에서 소스별 그룹핑.
   ...
   - 각 기사는 `* **[기사 제목](기사 URL)**: 요약 한 줄` 형태로 작성하며, URL이 없는 기사는 제외(스킵)하세요.
6. **post_title**: 날짜나 'AI 데일리 다이제스트' 등의 단어 없이, **가장 중요한 상위 3개 뉴스의 핵심 요약 제목**을 콤마(,)로 연결하여 작성하세요. (예: "오픈AI 새 모델 발표, 메타 라마3 오픈소스 공개, 애플 AI 전략")
